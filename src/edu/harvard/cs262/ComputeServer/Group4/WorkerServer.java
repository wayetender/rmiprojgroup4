...
public class WorkerServer implements ComputeServer {
    ...
    /**
     * Creates a ComputeServer stub but does not register it with a LocateRegistry. Clients should
     * not connect to it directly, but instead through a WorkQueueServer.
     * 
    ...
    /**
     * Driver for the WorkerServer. Starts the compute server, registers it with the given
